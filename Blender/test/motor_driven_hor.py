...
def prepolymerization_kettle_motor_driven_end_horizontal(xdata: ndarray, ydata: ndarray,
...
if __name__ == '__main__':
    ...
    res = prepolymerization_kettle_motor_driven_end_horizontal(xdata=1000 * data[:, 1],  # mm/s2
                                                        ydata=1000 * data[:, 0],
