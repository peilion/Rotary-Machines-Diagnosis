...
if __name__ == '__main__':
    for index, item in enumerate((unbalance(AMP=250, FN=1486 / 60.0),
                                  misalignment(AMP=400, FN=1486 / 60.0),
        ...
        res = blender_motor_driven_end_horizontal_diagnosis(xdata=item[0],
                                                          ydata=item[1],
                                                          fs=51200,
                                                          R={0: 990, 1: 1486},
                                                          ...
                                                          harmonic_threshold= np.vstack((0.35 * np.ones((10,)),0.35 * np.ones((10,)))),
