...
def prepolymerization_kettle_blender(xdata: ndarray, fs: int, R: float, bearing_ratio: ndarray,
                                     cur: ndarray, th1: ndarray, th2: ndarray, teeth_num: ndarray):
    cur_mean = cur.mean()
...
if __name__ == '__main__':
    ...
    res = prepolymerization_kettle_blender(xdata=1000 * data,  # mm/s2
