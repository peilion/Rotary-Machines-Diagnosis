...
def chlorinecompressor_compressor_nondriven_end_horizontal_diagnosis(xdata: ndarray, ydata: ndarray, pressure: ndarray,
    ...
    mp_instance = CP_Compressor_NonDriven_Horizontal(x=x, y=y, r=R, pressure=pressure,
...
if __name__ == '__main__':
    for index, item in enumerate((unbalance(AMP=350, FN=10384 / 60.0),
        ...
        res = chlorinecompressor_compressor_nondriven_end_horizontal_diagnosis(xdata=item[0],
                                                                               ydata=item[1],
                                                                               fs=51200,
                                                                               R=10384.0,
