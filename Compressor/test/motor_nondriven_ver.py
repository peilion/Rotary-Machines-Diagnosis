...
def chlorinecompressor_motor_nondriven_end_vertical_diagnosis(xdata: ndarray, ydata: ndarray,
    ...
    mp_instance = CP_Motor_NonDriven_Vertical(x=x, y=y, r=R, bearing_ratio=bearing_ratio,
...
if __name__ == '__main__':
    for index,item in enumerate((unbalance(AMP=300, FN=1491 / 60.0),
                 ...
                 a_loose(AMP=300, FN=1491 / 60.0), b_loose(AMP=100, FN=1491 / 60.0))) :
        res = chlorinecompressor_motor_nondriven_end_vertical_diagnosis(xdata=item[0],
                                                                        ydata=item[1],
                                                                        fs=51200,
                                                                        R=1491.0,
