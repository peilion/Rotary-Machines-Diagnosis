...
def chlorinecompressor_motor_driven_end_horizontal_diagnosis(xdata: ndarray, ydata: ndarray,
                                                           ...
                                                           kurtosis_threshold: float,ma_threshold: ndarray,
    ...
    mp_instance = CP_Motor_Driven_Horizontal(x=x, y=y, r=R, bearing_ratio=bearing_ratio,
...
if __name__ == '__main__':
    ...
    for index, item in enumerate((unbalance(AMP=300, FN=1491 / 60.0),
        ...
        res = chlorinecompressor_motor_driven_end_horizontal_diagnosis(xdata=item[0],
                                                                     ydata=item[1],
                                                                     fs=51200,
                                                                     R=1491,
